...
class QuadTreeControl(ControlPanel):
    def __init__(self, ctx, key="quadtree_depth", parent = None):
        ...
        self.addFloatRange(layout,"Hyperintense Min",[0,1],self.ctx.params.get("qt:hyperMin", 0.8),"qt:hyperMin", "Hyperintense Max",[0,1],self.ctx.params.get("qt:hyperMax", 1.0),"qt:hyperMax")
        ...
        self.addFloatControl(layout, "Mean Hyper Threshold", [0, 1], self.ctx.params.get("qt:meanHyperTresh", 0.495), "qt:meanHyperTresh")
        self.addFloatControl(layout, "Mean Hypo Threshold", [0, 1], self.ctx.params.get("qt:meanHypoTresh", 0.2), "qt:meanHypoTresh")

        self.addIntControl(layout, "Sum Hyper Thres", [1, 100], self.ctx.params.get("qt:sumHyperThresh", 30), "qt:sumHyperThresh")
